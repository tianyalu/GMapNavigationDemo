 ...
 */
public class TrunkRouteCalculateActivity extends BaseRouteCalculateActivity {
    private static final String TAG = TrunkRouteCalculateActivity.class.getSimpleName();
    private AMapCarInfo aMapCarInfo;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trunk_route_calculate);
