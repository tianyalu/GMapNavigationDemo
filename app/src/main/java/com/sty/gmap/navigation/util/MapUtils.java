package com.sty.gmap.navigation.util;

/**
 * 参考：https://blog.csdn.net/i996573526/article/details/82117862
 * Created by Shi Tianyi on 2020/2/4/0004.
 */
...
public class MapUtils {
    ...
    public static double[] bdToGaoDe(double bd_lat, double bd_lon) {
        ...
        gd_lat_lon[0] = z * Math.cos(theta); //经度
        gd_lat_lon[1] = z * Math.sin(theta); //纬度
        return gd_lat_lon;
    }
    ...
    public static double[] gaoDeToBaidu(double gd_lon, double gd_lat) {
        ...
        double z = Math.sqrt(x * x + y * y) + 0.00002 * Math.sin(y * PI);
        double theta = Math.atan2(y, x) + 0.000003 * Math.cos(x * PI);
        bd_lat_lon[0] = z * Math.cos(theta) + 0.0065; //经度
        bd_lat_lon[1] = z * Math.sin(theta) + 0.006; //纬度
        return bd_lat_lon;
    }
